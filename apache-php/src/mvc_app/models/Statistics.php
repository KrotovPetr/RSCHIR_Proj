...
class Statistics extends \mvc_app\core\Model
{
    ...
    function create_water_mark($imageEx){
        ...
        $stamp = imagecreatefrompng('mvc_app/models/images/water_mark.png');
        ...
        imagecopyresampled(
            ...
            imagesy($stamp));
        #echo "tutt\n";
        imagepng($stamp_new,"mvc_app/models/images/resize_water_mark.png");
...
//        $graph->Add($lineplot);
        ...
        #echo "putput";
        $graph->Stroke('mvc_app/models/images/geo_plot.png');
        #echo "a?";
    }
...
// imagepng($graph->img->img);
        $graph->Stroke('mvc_app/models/images/plot_bar.png');
    }
    ...
    function drawImages(){
        ...
        #echo "do not fall";
        $images = array(
            "mvc_app/models/images/plot_bar.png",
