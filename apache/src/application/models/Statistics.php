...
DEFINE('WORLDMAP', 'application/models/images/worldmap1.png');

class Statistics extends \application\core\Model
{
    ...
    function create_water_mark($imageEx){
        ...
        $stamp = imagecreatefrompng('application/models/images/water_mark.png');
        ...
        imagecopyresampled(
            ...
            imagesy($stamp));
        #echo "tutt\n";
        imagepng($stamp_new,"application/models/images/resize_water_mark.png");
    ...
    function draw_plot_scatter()
    {
        ...
        // Display the graph
        $graph->Stroke('application/models/images/line_plot.png');
...
//        $graph->Add($lineplot);
        ...
        #echo "putput";
        $graph->Stroke('application/models/images/geo_plot.png');
        #echo "a?";
    }
...
//        $values = $labels_and_values["values"];
        ...
        $graph->Add($p1);
        //echo "what\n";
        $graph->Stroke("application/models/images/plot_pie.png");
    }
...
// imagepng($graph->img->img);
        $graph->Stroke('application/models/images/plot_bar.png');
    }
    ...
    function drawImages(){
        ...
        #echo "do not fall";
        $images = array(
            "application/models/images/plot_bar.png",
            "application/models/images/plot_pie.png",
            "application/models/images/line_plot.png",
            "application/models/images/geo_plot.png"
        );
        #echo count($images);
